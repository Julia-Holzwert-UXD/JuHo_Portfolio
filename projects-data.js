  ...
  projects: [
      ...
      detail: {
        ...
        sections: {
          ...
          result: [
            ...
            "Structured Complexity: Personas, flows, cognitive walkthroughs, and task models translate a broad and technically complex problem space into a coherent user centered system.",
            "Business and System Awareness: The project demonstrates the ability to design for real world constraints such as technical feasibility, privacy, adaptability, and team coordination while still protecting usability and trust."
          ],

          takeawayTitle: "Takeaway",
          takeaway: "This project shows my ability to work on complex interaction systems with many dependencies, edge cases, and stakeholder needs. It also reflects strong systems thinking, interface structuring, and the ability to turn broad and messy input into a coherent user centered concept. The strongest lesson was that in safety critical contexts, good UX is less about visual novelty and more about reducing ambiguity, clarifying situations, and supporting confident decisions."
        },
    ...
    //CampusTalk
    {
      ...
      detail: {
        ...
        sections: {
          summary: "CampusTalk is a mobile web app and desktop website concept designed to reduce prejudice against students. The platform combines educational content, quizzes, personal stories, and community features to create understanding in a way that feels accessible, credible, and non judgmental.",
          ...
          result: [
            ...
            "Interactive Awareness: Quizzes, stories, and perspective shifts turn abstract prejudice into something users can recognize and question.",
            "Research Based UX: Interviews, personas, and clustered findings were translated into a concept that connects social impact with practical interface design."
          ],

          takeawayTitle: "Takeaway",
          takeaway: "This project shows my ability to turn complex social research into a structured digital concept. It highlights strengths in synthesis, UX strategy, and designing for sensitive topics where trust, clarity, and tone are as important as functionality."
        },
      ...
      detail: {
        ...
        sections: {
          ...
          result: [
            ...
            "Inclusive Usability: Improvements benefited all users, not just those with disabilities, creating a smoother, more reliable experience across the board.",
            "Accessibility as Foundation: Treating Accessibility as the structural backbone rather than an add-on ensured every interaction, screen, and action works predictably and humanely."
          ],
          takeawayTitle: "Takeaway",
